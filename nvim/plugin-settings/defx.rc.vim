...
function! s:defx_mappings() abort
  ...
  "change directory
  nnoremap <silent><buffer><expr> l defx#is_directory() ? defx#do_action('multi', ['open', 'change_vim_cwd']) : 'C'
  nnoremap <silent><buffer><expr> h defx#do_action('multi', [['cd', '..'], 'change_vim_cwd'])
...
nmap <silent><C-g> :Defx<CR>
nmap <silent><C-i> :Defx `expand('%:p:h')` -search=`expand('%:p')`<CR>

"nnoremap <silent><C-b>:Defx <cr>
"nnoremap <silent><C-i>:call <sid>defx_open({'find_current_file': v:true
"})<CR>
